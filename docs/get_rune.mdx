...
To make it easier to use you can leverage [docker](https://www.docker.com/)! We have pre-built docker images that has been tested across all platforms and are stable. 
