...
<ReactPlayer controls width="100%" url="https://www.youtube.com/watch?v=tytpelD128s&t=91s" />
...
Check out [the Forge chapter](/docs/forge/) for an introduction to building and
deploying Runes with Forge. Otherwise if the low-level details are more your
thing, you may want to read through [the section on Rune](/docs/rune/).
